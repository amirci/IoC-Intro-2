...
namespace MavenThought.MediaLibrary.WebClient.Tests
{
    ...
    /// </summary>
    [Specification]
    public class When_windsor_resolves_greediest_constructor : WindsorContainerSpecification
    {
        /// <summary>
        ...
        /// </summary>
        [Test]
        public void Should_have_user()
        {
            this._actual.User.Should().Not.Be.Null();
        }
